...
// } from './schema';
// console.log(
//     "%cFORM IMPORT CHECK: admissionRegistrationSchema._def.effect?.type IS:",
//     "color: green; font-weight: bold;",
//     admissionRegistrationSchema._def.effect?.type
// );

// import { fetchAddressDetails, FIELD_DEPENDENCIES, LANGUAGE_OPTIONS } from './admissionFormTabUtils';
...
//                                 </div>
//                             </div>
//                             <div className="my-4 p-4 border border-dashed border-blue-500">
//                                 <h3 className="text-lg font-semibold mb-2 text-blue-700">POC Validation Test</h3>
//                                 <p className="text-sm text-gray-600 mb-2">
//                                     Instructions: <br />
//                                     1. Select "Other" for Gender. <br />
//                                     2. Leave "Specify Other Gender" blank. <br />
//                                     3. Click the "Test Gender Validation" button. <br />
//                                     4. Check the console for "POC Errors" and see if `other_gender` has an error.
//                                 </p>
//                                 <Button
//                                     type="button" // Important: type="button" so it doesn't submit the form
//                                     variant="outline"
//                                     // POC Button onClick in AdmissionRegistrationForm.tsx
//                                     onClick={async () => {
//                                         console.log("--- POC: Test Gender Validation Clicked ---");
//                                         console.log("Current form values BEFORE trigger:", form.getValues()); // Log values

//                                         // Option 1: Trigger all fields (should work)
//                                         const allFieldsValid = await form.trigger();
//                                         console.log("form.trigger() isValid:", allFieldsValid);

//                                         // Option 2: Trigger specific fields (for more targeted testing)
//                                         // const specificFieldsValid = await form.trigger(["gender", "other_gender"]);
//                                         // console.log("form.trigger(['gender', 'other_gender']) isValid:", specificFieldsValid);

//                                         console.log("POC Errors AFTER trigger:", form.formState.errors);
//                                         if (form.formState.errors.other_gender) {
//                                             console.log("Error for other_gender in formState:", form.formState.errors.other_gender.message);
//                                         } else if (form.getValues("gender") === "Other") {
//                                             console.log("No error on other_gender in formState, but gender is Other.");
//                                         }
//                                     }}
//                                     className="bg-blue-100 hover:bg-blue-200 text-blue-700"
//                                 >
//                                     Test Gender Validation (POC)
//                                 </Button>
//                             </div>
//                         </section>
//                     </TabsContent>
...
//                                         {renderField("q1_applicant_response", { label: "Why are you opting to enroll in the IHS Post-10 Program? What do you hope to gain in a 3 year program here, as opposed to regular 2 year program elsewhere? (Applicant)", fieldtype: "Small Text", reqd: 1 })}
//                                         {renderField("q2_applicant_response", { label: "Can you talk us through the reasons behind the subject combination you have chosen? What do you see yourself doing in the future? (Applicant)", fieldtype: "Small Text", reqd: 1 })}
//                                         {renderField("q3_applicant_response", { label: "What activity do you love doing the most? Why? It could be singing in the shower, talking on the telephone, exploring the further reaches of YouTube, anything (We are more interested in the why). (Applicant)", fieldtype: "Small Text", reqd: 1 })}
//                                         {renderField("q4_applicant_response", { label: "If you could change one thing about the world, what would it be, and why?", fieldtype: "Small Text", reqd: 1 })}
//                                         {renderField("q5_applicant_response", { label: "If you could change one thing about yourself, what would it be, and why? (Applicant)", fieldtype: "Small Text", reqd: 1 })}
//                                         {renderField("q6_applicant_response", { label: "Describe your dream vacation. (Applicant)", fieldtype: "Small Text", reqd: 1 })}
//                                         {renderField("q7_applicant_response", { label: "Is there anything else want to share with us but couldn’t write anywhere else? This is the place, but please don’t feel like you have to write something here. This question is optional. (Applicant)", fieldtype: "Small Text", reqd: 1 })}
//                                     </div>
//                                     {/* Parent Questions */}
