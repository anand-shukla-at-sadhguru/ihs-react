    ...
    <Card>
      <div className="max-w-3xl mx-auto px-4 py-8">
        ...
        <p className="mb-4 text-base md:text-lg">
          Thank you for your interest in Isha Home School. As you consider applying to Isha Home School for your child, please go through the various sections of our website (prospectus may vary with prior application). Please use a desktop/laptop to fill the form (do not use tablets/phones for that).
        </p>
